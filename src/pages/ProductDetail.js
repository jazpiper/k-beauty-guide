...
function IngredientsPanel({ ingredientItems }) {
  return (
...
function CautionsPanel({ flagItems }) {
  return (
...
function WhereToBuyPanel({ purchaseLinks, fallbackSearchUrl }) {
  return (
    <section className="pd-panel">
      <div className="pd-section-heading">
        <h2>Where to Buy</h2>
...
function SourceEvidencePanel({ sourceLinks, hasAnySourceEvidence }) {
  return (
    <section className="pd-panel">
      <div className="pd-section-heading">
...
function RecommendedProductsPanel({ recommendedItems, navigate }) {
  return (
    <section className="pd-panel">
      <div className="pd-section-heading">
