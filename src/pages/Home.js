...
const TIPS = [
  {
    ...
    desc: "Point your camera at any product label for instant ingredient analysis",
  },
  {
    icon: "🗺️",
    title: "Find Stores",
    desc: "Discover the best K-beauty spots in Myeongdong, Hongdae & more",
  },
  {
    icon: "💆",
    title: "Skin Quiz",
    desc: "Get personalized product recommendations for your skin type",
  },
];
    ...
    <div>
      ...
      <section className="hero">
        ...
        <h1 className="hero-title">
          Discover <span className="gradient-text">Korean Beauty</span>
          <br />
          Like Never Before
        </h1>
        <p className="hero-desc">
          Search products, decode ingredients, and find the best beauty spots
          across Korea — all in one place.
        </p>
        ...
        <div className="tags">
          {["Hyaluronic Acid", "Niacinamide", "COSRX", "Sunscreen SPF50"].map(
            (tag) => (
              <button
                key={tag}
                type="button"
      ...
      <section className="section">
        <h2 className="section-title">
          Browse by <span className="pink">Category</span>
        </h2>
        <div className="categories">
          {CATEGORIES.map((c) => (
            <button
              ...
              onClick={() =>
                navigate(`/products?category=${encodeURIComponent(c.label)}`)
              }
            >
      ...
      <section className="section">
        <div className="section-header">
          <h2 className="section-title">
            🔥 Trending <span className="pink">Now</span>
          </h2>
          <button
            type="button"
            className="view-all"
        ...
        <div className="section">
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            <h2 className="section-title">
              ...
              <span className="pink">K-Beauty Journey</span>
            </h2>
            <p style={{ color: "#999", fontSize: 14, marginTop: 8 }}>
              Tools designed specifically for international beauty lovers
            </p>
          </div>
        ...
        <div className="banner">
          <div>
            ...
            <div className="banner-desc">
              Get your personalized K-beauty routine in 2 minutes
            </div>
          </div>
          <button
            type="button"
            className="banner-btn"
            onClick={() => setActivePage("Skin Quiz")}
          >
            Start Quiz →
          </button>
        </div>
      ...
      <footer className="footer">
        <div style={{ fontSize: 18, marginBottom: 8, color: "#FF6B9D" }}>
          🌸 <strong>K-Beauty Guide</strong>
        </div>
        <div>
          Made with 💕 for international K-beauty lovers · Seoul, Korea 🇰🇷
        </div>
      </footer>
    </div>
  );
