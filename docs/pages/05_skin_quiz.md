...
사용자의 피부 타입을 진단하고 **개인화된 K-뷰티 루틴을 추천**하는 인터랙티브 퀴즈.  
...
**개선 사항**
- [ ] **결과 미리보기** — "Dry, Oily, Combination, Sensitive, Normal 5가지 타입 진단" 시각화
- [ ] **재진단 안내** — 이전 결과가 있는 경우 "지난 결과: Oily Skin" + 다시하기 옵션
...
- [ ] **SNS 공유** — "나는 Oily Skin! K-Beauty Quiz 결과 →" 텍스트 + 링크
- [ ] **결과 URL** — `/quiz/result?type=oily` 로 딥링크 공유 가능

**영속화**
- [ ] **LocalStorage 저장** — 퀴즈 결과·답변 이력 보관
...
- Phase 3: Claude API 기반 완전 개인화 루틴
...
- **성분 알레르기 입력** — 피해야 할 성분 사전 등록 후 필터링
